        ...
        <form action={functionActions}>
            ...
            <Card className="w-[350px]">
                <CardHeader>
                    ...
                    <CardDescription>Fill out form below create a new task</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="grid w-full items-center gap-4">
                        ...
                        <div className="flex flex-col space-y-1.5">
                            ...
                            <Textarea name="description" id="description" placeholder="Type your message here." defaultValue={task?.description || ''} />
                        </div>
                        <div className="flex flex-col space-y-1.5">
